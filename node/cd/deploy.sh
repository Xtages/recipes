...
--tag 606626603369.dkr.ecr.us-east-1.amazonaws.com/"${XTAGES_ORG}"/"${XTAGES_PROJECT}-${XTAGES_APP_ENV}:$TAG" .
...
terraform init \
  -backend-config "key=tfstate/us-east-1/production/${TF_VAR_ORG}/${TF_VAR_APP_NAME}/app/${TF_VAR_APP_ENV}"
