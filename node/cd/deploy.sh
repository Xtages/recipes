...
IMAGE_NAME="606626603369.dkr.ecr.us-east-1.amazonaws.com/${XTAGES_ORG}/${XTAGES_PROJECT}:staging-${XTAGES_GH_PROJECT_TAG}"
docker build --build-arg XTAGES_NODE_VERSION="${XTAGES_NODE_VER}" --tag "${IMAGE_NAME}" .
